...
import { Conversation, SelectedConversation } from "@/types";
import React, { ReactNode, useContext } from "react";

export interface IButtonChatShopProps {
...
export function ButtonChatShop({
  ...
  return (
    <button type="button" className={className} onClick={handleMessageNow}>
      <svg
